    ...
    >
      ...
      <div className="xl:max-w-sectionWidth max-w-[62.5rem] mx-auto flex flex-col gap-y-20">
        ...
        <div className="grid lg:grid-cols-[65%_25%] grid-cols-1 lg:gap-[10%] gap-10">
          ...
          <div className="bg-white shadow-cardShadow p-10 grid lg:grid-cols-4 md:grid-cols-3 grid-cols-2 gap-8 lg:w-full w-[80%] lg:mx-0 mx-auto place-items-center rounded-lg lg:order-1 order-2 transition-all duration-300 hover:shadow-2xl">
            {skillsList.map(({ SkillIcon, title, level }, index) => (
              ...
              >
                ...
                <div className="flex flex-col gap-y-2 text-center">
                  ...
                  <h4 className="font-normal text-light">{level}</h4>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="grid lg:grid-cols-[25%_65%] grid-cols-1 lg:gap-[10%] gap-10">
          ...
          <div className="flex flex-col justify-center items-center order-1 lg:text-start text-center">
            ...
            <p className="font-normal lg:max-w-[750px] md:max-w-[650px] md:text-[1em] text-[0.9em] lg:text-start text-center">There are some formal education & awards that i've reached below</p>
          </div>

          {/* Educations & Awards Content */}
          <div className="bg-white shadow-cardShadow p-10 grid lg:grid-cols-2 grid-cols-1 gap-8 rounded-lg lg:w-full w-[80%] lg:mx-0 mx-auto order-2 transition-all duration-300 hover:shadow-2xl">
            {/* Educations Content */}
            <div className="flex flex-col gap-y-6">
              <h3 className="font-medium bg-primary text-white px-3 py-1 w-fit rounded-md flex items-center gap-x-2 transition-all duration-300 hover:-translate-y-2">
              ...
              {educationList.map(({ years, school, competence }, index) => (
                ...
                >
                  ...
                  <span className="font-normal text-light">{years}</span>
                </div>
              ))}
            </div>
