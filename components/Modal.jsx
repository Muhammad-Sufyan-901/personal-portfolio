  ...
  if (isOpen) {
    return (
      <div
        ...
        {...props}
      >
        <div className={`${isOpen ? "animate-fromTopAnimation" : "animate-toTopAnimation"} relative bg-white shadow-xl max-w-[600px] m-5 p-10 rounded-[10px] transition-all duration-300`}>
          <MdClose
            onClick={closeModal}
